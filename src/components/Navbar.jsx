      ...
      <div className="nav-content">
        <div className="nav-left">
          ...
          <div className="nav-links">
            ...
            <Link 
              to="/goals/create" 
              className={`nav-link ${location.pathname === '/goals/create' ? 'active' : ''}`}
            >
              목표 등록
            </Link>
            <Link 
              to="/participations" 
              className={`nav-link ${location.pathname === '/participations' ? 'active' : ''}`}
            >
              참여 현황
            </Link>
            <Link 
              to="/comments" 
              className={`nav-link ${location.pathname === '/comments' ? 'active' : ''}`}
            >
              코멘트
            </Link>
          </div>
