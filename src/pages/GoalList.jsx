      ...
      {!isMobile ? (
          ...
          <table className="goal-table">
            ...
            <tbody>
              {goals.map(goal => (
                ...
                >
                  <td onClick={() => handleGoalClick(goal.id)} style={{ cursor: 'pointer' }}>
                    {goal.id}
                  </td>
                  <td onClick={() => handleGoalClick(goal.id)} style={{ cursor: 'pointer' }}>
                    {goal.title}
                  ...
                  <td onClick={() => handleGoalClick(goal.id)} style={{ cursor: 'pointer' }}>
                    <span className={`status ${goal.goal_status.toLowerCase()}`}>
                      {goal.goal_status}
                    </span>
                  </td>
                  <td onClick={() => handleGoalClick(goal.id)} style={{ cursor: 'pointer' }}>
                    {goal.is_closing_soon && <span className="closing-badge">마감임박</span>}
                  </td>
                  <td>
                    <button 
        ...
        <div className="card-container">
          {goals.map(goal => (
            <div 
              key={goal.id} 
              className={`goal-card ${goal.is_closing_soon ? 'closing-soon' : ''}`}
              ...
              <div className="card-content">
                <div className="card-info">
                  ...
                  <div className="info-item">
                    ...
                    <span className="value">{goal.current_participants}/{goal.participants_limit}</span>
                  </div>
                  <div className="info-item">
